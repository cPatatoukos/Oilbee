...
@section('content')
    <div class="container mt-50 mb-80 text-h6 text-oil-darkest"> 
        ...
        <div class="flex justify-between mb-50">
            <a href="/" class="flex justify-start items-start md:items-center mb-30 text-oil-darkest text-h6 hover:text-oil-darker">
                <span class="arrow left w-15 h-15 p-px mr-10"></span>
                <span class="-mt-5 md:mt-0">back</span>
            </a>
            <h1 class="text-h4 md:text-h2 text-center mt-60 md:mt-0">Our top quality Olive oil!</h1>
                    ...
                    <div class="md:flex justify-center overflow-x-scroll">  
                        @foreach ($category as $item)
                            <div class="mb-60 md:mr-20">
                                <a href="/olive-oil/{{ $item->name }}" class="mx-auto flex justify-center mb-20">
                                    <img src="/images/oil.jpeg" class="w-200 h-200 lg:w-300 lg:h-300 rounded-lg">
                                </a>
                                <a href="/olive-oil/olive-oil" class="text-h6 text-oil-darkest italic font-bold mx-auto md:w-250px text-center">{{ $item->name }} {{ $item->category }}</a>
